...
interface FileExportButtonProps extends StandardEditorProps<string, any, { chartType?: string }> {}

export const FileExportButton: React.FC<FileExportButtonProps> = ({ value, item }) => {
